...
| [`customer-friction-radar`](customer-friction-radar/SKILL.md) | Detect, validate, and maintain evidence-backed customer-friction themes across reviews, assisted-service interactions, digital telemetry, and operational signals, with a lightweight Confluence ontology. |
