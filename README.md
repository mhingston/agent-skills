...
| [`model-lab`](model-lab/SKILL.md) | Develop, fine-tune, and select task-specific models from compact specialists to large generative LLMs through dataset/trace qualification, method selection, bounded training, protected matched evaluation, reproducible lineage, and Pareto-aware promotion. |
