---
name: lsp-config
description: Detect languages in a repository, create or refresh `.github/lsp.json` for GitHub Copilot CLI, and merge VS Code extension recommendations into `.vscode/extensions.json`. Use when LSP [...]
---
